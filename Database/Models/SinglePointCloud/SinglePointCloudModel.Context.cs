...
namespace Database.Models.SinglePointCloud
{
    using System;
    ...
    public partial class SinglePoint_CloudEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> SP_CloneDatabaseForAccount(string userId, Nullable<bool> allowRiskManager, Nullable<bool> allowFileRepository, Nullable<bool> allowBusinessCard, Nullable<bool> allowDAC6)
        {
            ...
            var allowRiskManagerParameter = allowRiskManager.HasValue ?
                new ObjectParameter("AllowRiskManager", allowRiskManager) :
                new ObjectParameter("AllowRiskManager", typeof(bool));
    
            var allowFileRepositoryParameter = allowFileRepository.HasValue ?
                new ObjectParameter("AllowFileRepository", allowFileRepository) :
                new ObjectParameter("AllowFileRepository", typeof(bool));
    
            var allowBusinessCardParameter = allowBusinessCard.HasValue ?
                new ObjectParameter("AllowBusinessCard", allowBusinessCard) :
                new ObjectParameter("AllowBusinessCard", typeof(bool));
    
            var allowDAC6Parameter = allowDAC6.HasValue ?
                new ObjectParameter("AllowDAC6", allowDAC6) :
                new ObjectParameter("AllowDAC6", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("SP_CloneDatabaseForAccount", userIdParameter, allowRiskManagerParameter, allowFileRepositoryParameter, allowBusinessCardParameter, allowDAC6Parameter);
        }
