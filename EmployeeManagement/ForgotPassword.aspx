...
<body >
    <form id="frmForgotPassword" class="login-form" runat="server">
...
">
                         <div class="mb-3 mt-3  pt-4 w-100" style=" padding-bottom: 23px;">
                             ...
                             <%}%>   
                             <button id="btnLogin" class="mt-2 Sign-in-Button btn btn-16 btn-height  m-btn--wide-normal"><span style="color:white">Reset</span></button>
                            <div class="pt-4">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btnResetPassword").on("click", function () {
                ...
                var url = 'ForgotPassword.aspx/SendResetPasswordLink';
