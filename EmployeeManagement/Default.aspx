<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EmployeeManagement.Default" %>
        ...
        padding-left: 48px;">
                        <div class="mb-3 mt-3  pt-4 w-100" style=" padding-bottom: 23px;">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="form-group pt-1 margin-bottom" >
                             ...
                             <%}%>   
                                <button id="btnLogin" type="button" class="mt-2 Sign-in-Button btn btn-16 btn-height  m-btn--wide-normal"><span style="color:white;">Sign In</span></button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        txbPassword.addEventListener("keydown", function (e) {
            if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                LoginUser();
            }
        });

        txbUserName.addEventListener("keydown", function (e) {
            if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                LoginUser();
            }
        });
    ...
    LoginUser = function () {
     ...
     //   debugger;
        ...
        $("#ajaxLoader").modal("show");
        var url = 'Default.aspx/LoginUser';
        AjaxPostRequestWithRequestPerameters(url, requestPerameters, function (response) {
