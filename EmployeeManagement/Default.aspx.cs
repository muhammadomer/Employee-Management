        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    try
                    {
                        string srcPath = HttpContext.Current.Server.MapPath("images/1/");
                ...
                {
                    Log4Net.WriteLog("Accound Manage Request From Cloud Admin", LogType.GENERALLOG);
                ...
                else
                {
                    ...
                    else if (Convert.ToInt32(ConfigurationManager.AppSettings["OtherApplication"]) == 0)
                    {
