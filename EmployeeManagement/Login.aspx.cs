    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        public static string LoginUser(string userName, string password, string accountID)
        {
         ...
         //       string feedback = "";
                ...
                {
                    userEntity = userDAL.CheckUserAuthentication(userName, password); // 2 DB Calls
                    feedback = userDAL.LoginUser(userEntity); // 2 DB Calls
            ...
            {
                Log4Net.WriteException(ex);
                feedback = "Wrong Account ID found.";
                return feedback;
          //      throw ex;
            }
        }
